...
import com.cassur.fortscale.api.rest.CassurFortscaleController;
...
@Profile("test")
public class CassurFortscaleControllerTest {

    private static final String RESOURCE_LOCATION_PATTERN = "http://localhost/cassur/fortscale/v1/users/[0-9]+";

    @InjectMocks
    CassurFortscaleController controller;
    ...
    public void shouldHaveEmptyDB() throws Exception {
        mvc.perform(get("/cassur/fortscale/v1/users")
    ...
    public void shouldCreateRetrieveDelete() throws Exception {
        ...
        //CREATE
        MvcResult result = mvc.perform(post("/cassur/fortscale/v1/users")
                .content(r1Json)
        ...
        //RETRIEVE
        mvc.perform(get("/cassur/fortscale/v1/users" + id)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
...
//                .andExpect(jsonPath("$.rating", is(r1.getRating())));
        ...
        //DELETE
        mvc.perform(delete("/cassur/fortscale/v1/users" + id))
 ...
 */
    ...
    public void shouldCreateAndUpdateAndDelete() throws Exception {
        ...
        //UPDATE
        result = mvc.perform(put("/cassur/fortscale/v1/users" + id)
                .content(r2Json)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent())
